...
-- NOTE: The application will use these lab table names:
-- doctor, doctor_available_times, patient, appointment, admin.
-- Create the tables first, then insert the sample data.
 

-- Sample inserts for `doctor`
...
-- Sample inserts for `doctor_available_times`
...
-- Sample inserts for `appointment`
